...
import com.mindforge.app.domain.model.ModelFilter
import com.mindforge.app.domain.model.ModelInfo
import com.mindforge.app.domain.model.SearchResult
    ...
    suspend operator fun invoke(
        ...
        return runCatching {
            ...
            models = when (filters.sortBy) {
                com.mindforge.app.domain.model.SortBy.DOWNLOADS -> models.sortedByDescending { it.downloads }
                com.mindforge.app.domain.model.SortBy.LIKES -> models.sortedByDescending { it.likes }
                com.mindforge.app.domain.model.SortBy.RECENT -> models.sortedByDescending { it.lastModified }
            }
